-- Paid-traffic attribution for landing-page leads, on the global data plane.
--
...
--
-- Mirrors backend/prisma/ru/migrations of the same name. See docs/RU_MINIMUM_SCHEMA.md §1.3
